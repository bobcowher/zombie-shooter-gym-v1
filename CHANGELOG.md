...
### Changed
- **BREAKING**: `use_shotgun` parameter now defaults to `False` regardless of `render_mode`
- Removed automatic shotgun enabling for human render mode
- Examples now explicitly set `use_shotgun=True` when needed
- This provides more consistent and predictable environment behavior

### Fixed
- Clarified action descriptions in basic_usage.py example

## [0.1.2] - 2026-03-28 (Unreleased)
